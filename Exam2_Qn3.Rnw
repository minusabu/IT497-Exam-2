...
graph2<-source_url("https://raw.githubusercontent.com/minusabu/IT497-Exam-2/master/Exam2_Qn3_Remote.R")

#display the graph
print(graph2)

@
Typically, majority of the fitbit users take between 0 and 15000 steps a day.\\ 
\end{document}